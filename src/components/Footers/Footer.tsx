...
const Footer = () => {
  ...
  return (
    <footer className="bg-black w-full py-2 flex flex-col item-center border-t-[3px] border-primary">
          ...
          <div className="flex gap-4 w-full pt-3">
            {footerData.map((section, index) => (
              <div key={index} className="flex flex-col gap-4 lg:gap-5 w-full">
                <p className="text-red-300 font-[500] text-base leading-[1.6]">
                  {section.title}
                </p>
          ...
          <div className="flex lg:gap-8 w-full pt-3">
            {footerData.map((section, index) => (
              <div key={index} className="flex flex-col gap-2 sm:gap-5 w-full">
                <span className="text-secondary-500 font-[500] text-sm sm:text-base leading-[1.6]">
                  {section.title}
                </span>
